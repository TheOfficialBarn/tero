...
export default function FileList() {
  ...
  const refreshFiles = async () => {
    ...
    try {
      ...
      if (!address) {
        const connection = await connectWalletHandler();
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                For the best experience on iOS, please open this PWA in your browser or install MetaMask mobile app.
                <a href={`https://metamask.app.link/dapp/${window.location.host}`} className="font-medium underline text-yellow-700 hover:text-yellow-600 ml-1">
                  Open in MetaMask
                </a>
              </p>
            </div>
